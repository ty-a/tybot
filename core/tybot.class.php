...
class tybot

  {
    ...
    function post_to_wiki($dataToPost)
      {
    ...
    function edit($page, $text, $summary = '', $bot = 1)
      {
    ...
    function undelete($page, $summary = '')
      {
        global $token;
        $dataToPost = array(
            'action' => 'undelete',
    ...
    function userrights($targetUser, $add = '', $remove = '', $summary = '')
      {
    ...
    function protect($page, $movelevel = '', $editlevel = '', $expiry = '', $summary = '')
      {
        global $token;
        $dataToPost = array(
            'action' => 'protect',
    ...
    function block($target, $summary = '', $expiry = "infinite")
      {
        global $token;
        $dataToPost = array(
            'action' => 'block',
    ...
    function unblock($target, $summary = '')
      {
        global $token;
        $dataToPost = array(
            'action' => 'unblock',
    ...
    function get_category_members($category, $limit = "max")
      {
        $cmcontinue = '';
        while (true)
          {
    ...
    function find_and_replace($page, $find, $replace)
      {
    ...
    function get_users_in_group($group, $amount = "max")
      {
        $dataToPost = array(
            'action' => 'query',
            'list' => 'allusers',
    ...
    function get_random_pages($limit = 10, $namespace = 0)
      {
        $dataToPost = array(
            'action' => 'query',
            'list' => 'random',
    ...
    function get_all_pages($redirects = "nonredirects", $namespace = 0, $limit = "max")
      {
        $apfrom = '';
        $pages = array();
        while (true)
    ...
    function get_what_links_here($page, $limit = "max", $redirects = "all")
      {
        $blcontinue = '';
        while (true)
          {
    ...
    function get_user_contribs($user, $namespace = '', $limit = 'max', $all = true)
      {
        $ucstart = '';
        $contribs = array();
        while (true)
